...
public class Wise_Cal_ {
	...
	private void initialize() {
		...
		frmWisecal.addMouseListener(new MouseAdapter() {
			@Override
		...
		frmWisecal.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseDragged(MouseEvent e) {
				int x = e.getXOnScreen();
				int y = e.getYOnScreen();
				frmWisecal.setLocation(x - xMouse, y - yMouse);
			}
		});
		...
		bnt_Equals.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (isOperationPreformed == true
					...
					current_Op_Field.setText(firstNum + "" + opPreformed + "" + secondNum);
				...
				if (isOperationPreformed == true) {
					...
					if (textBox_Result.getText().length() < 7) {
						if (comment_Field.getText().equals(null)) {
							...
							comment_Field.setText(resultComments[r++]);
						commentsMade++;
					...
					if (textBox_Result.getText().length() > 7) {
						if (comment_Field.getText().equals(null)) {
							...
							comment_Field.setText(largeResultComments[r++]);
						commentsMade++;
					}
					// -----------------------------------------------------------------------------|largeInt
					// Comments|
				...
				System.out.println("isOperationPreformed " + isOperationPreformed + "-" + " Opration " + " = "
						+ opPreformed + " commentMade(s) " + " = " + commentsMade);
